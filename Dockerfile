...
ARG ADDITIONAL_PACKAGES="upquote babel-german german breakurl times courier relsize biblatex xkeyval bigfoot xstring frankenstein csquotes acronym biblatex-chicago lineno biber appendix makecell subfig caption float minted"
